	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0 280px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="指数值" prop="zhishuzhi">
					<el-input v-model="ruleForm.zhishuzhi" placeholder="指数值" clearable  :readonly="ro.zhishuzhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="指数值" prop="zhishuzhi">
					<el-input v-model="ruleForm.zhishuzhi" placeholder="指数值" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhishuzhi'){
							this.ruleForm.zhishuzhi = obj[o];
							this.ro.zhishuzhi = true;
							continue;
						}
						if(o=='xiangqing'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `bmizhishu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.bmizhishuCrossAddOrUpdateFlag = false;
						 this.parent.search();
